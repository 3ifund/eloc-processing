"""
OpenAI verification service implementation.
"""
import json
import logging
...
class OpenAIVerificationService(BaseVerificationService):
    """OpenAI-based verification service"""
    ...
    async def verify_company(
        ...
        try:
            ...
            logger.info(f"OpenAI company extraction: {extracted}")
    ...
    async def verify_signatory(
        ...
        try:
            ...
            logger.info(f"OpenAI signatory extraction: {extracted}")
    ...
    async def verify_transaction(
        ...
        try:
            ...
            logger.info(f"OpenAI transaction extraction: {extracted}")
